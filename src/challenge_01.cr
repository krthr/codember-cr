...
#
# El resultado será una cadena de texto con la palabra y el número de veces
# que aparece en el mensaje, con este formato:
...
words_count = MESSAGE.downcase.split(" ").reduce(
...
final_message = words_count.to_a.map { |pair| pair.join("") }.join("")
